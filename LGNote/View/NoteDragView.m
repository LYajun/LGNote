...
@interface NoteDragView ()<UIGestureRecognizerDelegate>
    ...
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:{//拖动中
            ...
            switch (self.dragDirection) {
                case NoteDragDirectionAny:
                    dx = point.x - self.startPoint.x;
                    dy = point.y - self.startPoint.y;
                    break;
                case NoteDragDirectionHorizontal:
                    dx = point.x - self.startPoint.x;
                    dy = 0;
                    break;
                case NoteDragDirectionVertical:
                    dx = 0;
                    dy = point.y - self.startPoint.y;
                    break;
                default:

...
@interface LGNNoteDrawSettingView ()<UICollectionViewDataSource,UICollectionViewDelegate,NoteDrawSettingButtonViewDelegate>
{
...
/** 画板背景图 */
@property (nonatomic, strong) LGNBoardBgImageView *boardImageView;
/** 画笔大小 */
@property (nonatomic, strong) LGNPenFontBallView *penFontView;
...
@implementation LGNNoteDrawSettingView
...
//   lg_notetool_image_ic_clik_checked
        _buttonView = [[LGNNoteDrawSettingButtonView alloc] initWithFrame:CGRectZero buttonNorImages:@[@"note_pencil_unselected",@"note_color_unselected",@"note_pho_newunselected",@"note_last_unselected",@"note_next_unselected",@"note_Newpho_selected"] buttonSelectedImages:@[@"note_pencil_selected",@"note_color_selected",@"note_Newpho_selected",@"note_last_selected",@"note_next_selected",@"note_Newpho_selected"] singleTitle:@"完成" ];
...
- (LGNBoardBgImageView *)boardImageView{
    if (!_boardImageView) {
        _boardImageView = [[LGNBoardBgImageView alloc] init];
...
- (LGNPenFontBallView *)penFontView{
    if (!_penFontView) {
        _penFontView = [[LGNPenFontBallView alloc] initWithFrame:CGRectMake(0, 0, 16, 16)];

...
// 拖曳view的方向
typedef NS_ENUM(NSInteger, NoteDragDirection) {
    NoteDragDirectionAny,          /**< 任意方向 */
    NoteDragDirectionHorizontal,   /**< 水平方向 */
    NoteDragDirectionVertical,     /**< 垂直方向 */
};

@interface NoteDragView : UIView
/**
 是不是能拖曳，默认为YES
 YES，能拖曳
 NO，不能拖曳
...
/**
 拖曳的方向，默认为any，任意方向
 */
@property (nonatomic,assign) NoteDragDirection dragDirection;
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(NoteDragView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(NoteDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(NoteDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(NoteDragView *dragView);
@end

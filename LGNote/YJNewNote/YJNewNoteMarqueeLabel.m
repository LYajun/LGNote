...
@interface YJNewNoteMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
@end
@implementation YJNewNoteMarqueeLabel
...
-(void)commonInit{
    self.marqueeLabelType = YJNewNoteMarqueeLabelTypeLeft;
...
-(void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == YJNewNoteMarqueeLabelTypeLeft) {

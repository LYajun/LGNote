...
#import "NoteLabelOnLeftButton.h"

@class NOteDropDownMenuView;

@protocol CFDropDownMenuViewDelegate <NSObject>

@optional

- (void)dropDownMenuView:(NOteDropDownMenuView *)dropDownMenuView clickOnCurrentButtonWithTitle:(NSString *)currentTitle andCurrentTitleArray:(NSArray *)currentTitleArray;

@end

@interface NOteDropDownMenuView : UIView <UITableViewDelegate, UITableViewDataSource>
/**
...
typedef void (^ChooseBtnBlock)(NSString *);
/* 代理 */

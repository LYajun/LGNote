...
@implementation NoteLabelOnLeftButton
...
{
    NoteLabelOnLeftButton *btn = [self buttonWithType:UIButtonTypeCustom];
...
- (void)layoutSubviews
{
    ...
    CGFloat imageWidth = self.imageView.cf_widthn+1;
    CGFloat labelWidth = self.titleLabel.cf_widthn+1;

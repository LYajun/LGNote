...
/**
 YJBMarqueeLabel is a UILabel subclass adds a scrolling marquee effect when the text of a label instance outgrows the available width. Instances of `YJBMarqueeLabel` can be configured
 for label scrolling direction/looping, speed/rate, and other options.
 */

IB_DESIGNABLE
@interface YJBMarqueeLabel : UILabel <CAAnimationDelegate>

////////////////////////////////////////////////////////////////////////////////
/// @name Creating YJBMarqueeLabels
////////////////////////////////////////////////////////////////////////////////

/** Returns a newly initialized `YJBMarqueeLabel` instance.
 ...
 @return An initialized `YJBMarqueeLabel` object or nil if the object couldn't be created.
*/

- (instancetype)initWithFrame:(CGRect)frame;


/** Returns a newly initialized `YJBMarqueeLabel` instance with the specified scroll rate and edge transparency fade length.
 ...
 @param fadeLength A length of transparency fade at the left and right edges of the `YJBMarqueeLabel` instance's frame.
 @see fadeLength
 @return An initialized `YJBMarqueeLabel` object or nil if the object couldn't be created.
 */
...
/** Returns a newly initialized `YJBMarqueeLabel` instance with the specified scroll duration and edge transparency fade length.
...
/** A boolean property that sets whether the `YJBMarqueeLabel` should behave like a normal UILabel.
 
 When set to `YES` the `YJBMarqueeLabel` will behave like a normal UILabel, and  will not begin scrolling when the text is
 larger than the specified frame. The change takes effect immediately, removing any in-flight animation as well as any
 current edge fade. Note that the `YJBMarqueeLabel` will respect the current values of the `lineBreakMode` and `textAlignment`
...
/** A boolean property that sets whether the `YJBMarqueeLabel` should hold (prevent) label scrolling.
 
 When set to `YES`, the `YJBMarqueeLabel` will not automatically scroll even its text is larger than the specified frame,
 although the specified edge fades will remain.
 
 To set the `YJBMarqueeLabel` to act like a normal UILabel, use the `labelize` property.
...
/** A boolean property that sets whether the `YJBMarqueeLabel` should only begin a scroll when tapped.
 
 If this property is set to `YES`, the `YJBMarqueeLabel` will begin a scroll animation cycle only when tapped. The label will
...
#else
@property (nonatomic, assign) YJBMarqueeType marqueeType;
#endif
...
/** The length of transparency fade at the left and right edges of the `YJBMarqueeLabel` instance's frame.
 
 This propery sets the size (in points) of the view edge transparency fades on the left and right edges of a `YJBMarqueeLabel`. The
...
/** Convenience method to restart all `YJBMarqueeLabel` instances that have the specified view controller in their next responder chain.
 
 This method sends a `NSNotification` to all `YJBMarqueeLabel` instances with the specified view controller in their next responder chain.
 ...
 @warning View controllers that appear with animation (such as from underneath a modal-style controller) can cause some `YJBMarqueeLabel` text
...
/** Labelizes all `YJBMarqueeLabel` instances that have the specified view controller in their next responder chain.
 
 This method sends an `NSNotification` to all `YJBMarqueeLabel` instances with the specified view controller in their next
 responder chain. The `labelize` property of these `YJBMarqueeLabel` instances will be set to `YES`.
 
 @param controller The view controller for which all `YJBMarqueeLabel` instances should be labelized.
 @see labelize
 */
...
/** De-Labelizes all `YJBMarqueeLabel` instances that have the specified view controller in their next responder chain.
 
 This method sends an `NSNotification` to all `YJBMarqueeLabel` instances with the specified view controller in their next
 responder chain. The `labelize` property of these `YJBMarqueeLabel` instances will be set to `NO` .
 
 @param controller The view controller for which all `YJBMarqueeLabel` instances should be de-labelized.
 @see labelize
 */

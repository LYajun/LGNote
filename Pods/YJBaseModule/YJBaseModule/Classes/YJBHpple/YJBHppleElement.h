...
@interface YJBHppleElement : NSObject
...
@property (nonatomic, strong, readonly) YJBHppleElement *firstChild;

// the parent of a node
@property (nonatomic, unsafe_unretained, readonly) YJBHppleElement *parent;

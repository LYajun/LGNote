...
@interface YJRFontsViewController () <UITableViewDelegate,UITableViewDataSource> {
    
    YJRFontFamily selectedFontFamily;
    
}

@end

@implementation YJRFontsViewController

@synthesize delegate;

#pragma mark - Init Section
+ (YJRFontsViewController *)cancelableFontPickerViewControllerWithFontFamily:(YJRFontFamily)fontFamily {
    return [[YJRFontsViewController alloc] initWithFontFamily:fontFamily];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:
        selectedFontFamily = YJRFontFamilyDefault;
        break;
        
        case 1:
        selectedFontFamily = YJRFontFamilyTrebuchet;
        break;
        
        case 2:
        selectedFontFamily = YJRFontFamilyVerdana;
        break;
        
        case 3:
        selectedFontFamily = YJRFontFamilyGeorgia;
        break;
        
        case 4:
        selectedFontFamily = YJRFontFamilyPalatino;
        break;
        
        case 5:
        selectedFontFamily = YJRFontFamilyTimesNew;
        break;
        
        case 6:
        selectedFontFamily = YJRFontFamilyCourierNew;
        break;
